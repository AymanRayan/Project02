...
var ProductModel = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        sql = "insert into ".concat(this.table, " (the_name,price) values($1,$2) RETURNING *");
                        return [4 /*yield*/, doQuery(sql, [product.the_name, product.price])];
                    case 1:
                        result = _a.sent();
    ...
    ProductModel.edit = function (product) {
        return __awaiter(this, void 0, void 0, function () {
            var sql, result, e_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        sql = "update ".concat(this.table, " set the_name = $2, price = $3 where id = $1 RETURNING *");
                        return [4 /*yield*/, doQuery(sql, [product.id, product.the_name, product.price])];
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, result.rows[0]];
                    case 2:
